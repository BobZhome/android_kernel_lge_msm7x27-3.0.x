...
initrd_phys-$(CONFIG_MACH_MSM7X27_GELATO)   := 0x13800000
   ...
   zreladdr-$(CONFIG_MACH_MSM7X27_THUNDERC)	:= 0x12808000
params_phys-$(CONFIG_MACH_MSM7X27_THUNDERC)	:= 0x12800100
initrd_phys-$(CONFIG_MACH_MSM7X27_THUNDERC)	:= 0x13800000
